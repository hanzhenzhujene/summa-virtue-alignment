...
RELATION_SENTENCES: dict[str, str] = {
    ...
    "deficiency_opposed_to": "{subject} is opposed to {object} by deficiency",
    "directed_to": "{subject} is directed to {object}",
    "excess_opposed_to": "{subject} is opposed to {object} by excess",
...
RELATION_FRAGMENTS: dict[str, str] = {
    ...
    "deficiency_opposed_to": "is opposed to {object} by deficiency",
    "directed_to": "is directed to {object}",
    "excess_opposed_to": "is opposed to {object} by excess",

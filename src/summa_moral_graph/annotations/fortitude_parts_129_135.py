...
from .fortitude_parts_129_135_spec import (
    FORTITUDE_PARTS_129_135_EXTRA_CONCEPTS,
...
class FortitudeParts129135Context:
...
def build_fortitude_parts_129_135_annotation_artifacts() -> dict[str, int]:
    """Build reviewed concept and annotation artifacts for II-II QQ. 129-135."""

    context = load_fortitude_parts_129_135_context()
    ...
    write_jsonl(
        GOLD_DIR / "fortitude_parts_129_135_reviewed_concepts.jsonl",
...
def load_fortitude_parts_129_135_context() -> FortitudeParts129135Context:
    questions = {
    ...
    for payload in FORTITUDE_PARTS_129_135_EXTRA_CONCEPTS:
    ...
    return FortitudeParts129135Context(
        questions=questions,
        articles=articles,
        passages=passages,
        concepts=concepts,
...
def build_reviewed_doctrinal_annotations(
    context: FortitudeParts129135Context,
...
def resolve_node_label_type(
    ...
    raise KeyError(f"Unknown fortitude parts 129-135 node id: {node_id}")

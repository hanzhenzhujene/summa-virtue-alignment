...
from .connected_virtues_109_120_spec import (
    CONNECTED_VIRTUES_109_120_EXTRA_CONCEPTS,
...
class ConnectedVirtues109120Context:
...
def build_connected_virtues_109_120_annotation_artifacts() -> dict[str, int]:
    """Build reviewed concept and annotation artifacts for II-II QQ. 109-120."""

    context = load_connected_virtues_109_120_context()
    ...
    write_jsonl(
        GOLD_DIR / "connected_virtues_109_120_reviewed_concepts.jsonl",
...
def load_connected_virtues_109_120_context() -> ConnectedVirtues109120Context:
    questions = {
    ...
    for payload in CONNECTED_VIRTUES_109_120_EXTRA_CONCEPTS:
    ...
    return ConnectedVirtues109120Context(
        questions=questions,
        articles=articles,
        passages=passages,
        concepts=concepts,
...
def build_reviewed_doctrinal_annotations(
    context: ConnectedVirtues109120Context,
...
def build_relation_annotation(
    ...
    return PilotAnnotationRecord(
        ...
        connected_virtues_cluster=seed.connected_virtues_cluster,
    )
...
def resolve_node_label_type(
    ...
    raise KeyError(f"Unknown connected virtues 109-120 node id: {node_id}")

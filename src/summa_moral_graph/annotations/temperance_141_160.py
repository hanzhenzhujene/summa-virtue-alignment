...
from .temperance_141_160_spec import (
    RELATION_SEEDS,
    TEMPERANCE_141_160_EXTRA_CONCEPTS,
...
def build_temperance_141_160_annotation_artifacts() -> dict[str, int]:
    """Build reviewed concept and annotation artifacts for II-II QQ. 141-160."""

    context = load_temperance_141_160_context()
    ...
    write_jsonl(
        GOLD_DIR / "temperance_141_160_reviewed_concepts.jsonl",
...
def load_temperance_141_160_context() -> Temperance141160Context:
    questions = {
    ...
    for payload in TEMPERANCE_141_160_EXTRA_CONCEPTS:
    ...
    return Temperance141160Context(
        questions=questions,
        articles=articles,
        passages=passages,
        concepts=concepts,
...
def build_reviewed_doctrinal_annotations(
    context: Temperance141160Context,
...
def resolve_node_label_type(
    ...
    raise KeyError(f"Unknown temperance 141-160 node id: {node_id}")
